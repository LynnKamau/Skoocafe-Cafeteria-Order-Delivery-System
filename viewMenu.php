...
<body>
    ...
    <div class="container my-4" id="cont">
        ...
        ?>
        <script> document.getElementById("title").innerHTML = "<?php echo $menuName; ?>"; </script> 
        <?php
        echo  '<div class="col-md-4">
                <img src="img/menu-'.$menuId. '.jpg" width="249px" height="262px">
            </div>
            <div class="col-md-8 my-4">
                <h3>' . $menuName . '</h3>
                <h5 style="color: #ff0000">KES. '.$menuPrice. '/-</h5>
                <p class="mb-0">' .$menuDesc .'</p>';
